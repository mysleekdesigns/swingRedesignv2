...
interface ThemeItem {
  name: string;
  key: 'light' | 'dark' | 'bubble-gum' | 'neon-cyberpunk';
  icon: typeof Sun;
}
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const handleThemeChange = (themeKey: 'light' | 'dark' | 'bubble-gum' | 'neon-cyberpunk') => {
    if (themeContext) {
  ...
  const themeItems: ThemeItem[] = [
    ...
    { name: 'Cyberpunk', key: 'neon-cyberpunk', icon: Zap },
  ];

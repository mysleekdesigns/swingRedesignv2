...
export const whoIsOnUsers: User[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=600&fit=crop&crop=face',
    isOnline: true,
    distance: '6 mi',
    photosCount: 17,
  },
...
export const whoViewedMeUsers: User[] = [
  ...
  },
  {
    ...
    age: 33,
    location: 'Calabasas',
    imageUrl: 'https://images.unsplash.com/photo-1521146764736-56c929d59c83?w=400&h=600&fit=crop&crop=face',
    distance: '22 mi',
    photosCount: 16,
  },
  {

...
type Theme = 'light' | 'dark' | 'bubble-gum' | 'cyberpunk' | 'neon-cyberpunk'
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    document.documentElement.classList.remove('dark', 'bubble-gum', 'cyberpunk', 'neon-cyberpunk')
    ...
    } else if (initialTheme === 'neon-cyberpunk') {
  ...
  const toggleTheme = () => {
    ...
    // Cycle through five themes: light -> dark -> bubble-gum -> cyberpunk -> neon-cyberpunk -> light
    let newTheme: Theme
    if (theme === 'light') {
      newTheme = 'dark'
    } else if (theme === 'dark') {

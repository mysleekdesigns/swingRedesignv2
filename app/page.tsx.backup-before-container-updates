...
import { Users, Eye, Heart, Calendar, MapPin, DollarSign, Shield, Zap, Star, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-64 p-4 sm:p-6 lg:p-8">
        ...
        <div className="w-full space-y-8">
          ...
          {/* Welcome and Convention Sections - 25/75 Split */}
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            {/* Welcome Section - 25% on desktop */}
              ...
              <div className="relative overflow-hidden rounded-3xl section-glass p-8 h-full">
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="flex-1 mb-6">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground text-sm mb-1">100% Safe & Verified</h3>
                          <p className="text-xs text-muted-foreground">ID verified profiles and secure connections</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground text-sm mb-1">Instant Matching</h3>
                          <p className="text-xs text-muted-foreground">AI-powered matches based on your preferences</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground text-sm mb-1">Premium Experience</h3>
                          <p className="text-xs text-muted-foreground">Exclusive events and VIP member benefits</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground text-sm mb-1">Active Community</h3>
                          <p className="text-xs text-muted-foreground">Join thousands of members online now</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button className="px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground hover:text-primary-foreground rounded-xl font-semibold transition-colors flex items-center gap-2">
            ...
            <div className="lg:w-3/4 lg:flex-shrink-0">
              <div className="relative overflow-hidden rounded-3xl section-glass p-8 h-full">

          ...
          <div className="px-4 lg:px-6 pb-8">
            {activeSection === 'who-viewed' && (
              <>
                ...
                <div className="hidden lg:flex lg:gap-4 lg:overflow-x-auto lg:pb-4 scrollbar-hide">
                  {whoViewedMeUsers.slice(0, 12).map((user) => (
                    <div key={user.id} className="flex-shrink-0 w-[calc(100%/6-20px*5/6)] 2xl:w-[calc(100%/8-16px*7/8)]">
                      <UserCard
                        {...user}
                        variant="default"
                        showActions={true}
